...
export const companyDirectory: CompanyDirectoryCategory[] = [
  {
    ...
    companies: [
      ...
      company("携程集团", "携程", "https://careers.ctrip.com/", ["携程", "Trip.com", "Ctrip"]),
  ...
  },
  {
    ...
    companies: [
      ...
      company("耐克", "NIKE", "https://careers.nike.com/", ["Nike"]),
      ...
      company("泡泡玛特", "POP", "https://www.popmart.com.cn/cn/careers", ["POP MART"]),
  ...
  },
  {
    ...
    companies: [
      ...
      company("大疆创新", "DJI", "https://careers.dji.com/zh-CN/campus", ["大疆", "DJI"]),
      company("荣耀", "HONOR", "https://career.hihonor.com/", ["荣耀终端", "Honor"]),
      company("海尔", "海尔", "https://maker.haier.net/client/campus/activityindex.html", ["海尔集团", "Haier"]),
      ...
      company("安克创新", "Anker", "https://career.anker.com.cn/universities/recruitment/new/?channel=campus", ["Anker"]),
  ...
  },
  {
    ...
    companies: [
      ...
      company("极氪", "ZEEKR", "https://www.zeekrlife.com/global/careers", ["极氪汽车", "Zeekr"]),
