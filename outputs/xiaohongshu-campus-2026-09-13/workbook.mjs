...
s.getRange('B3').values=[[`2026-09-13 采集，共 ${jobs.length} 个岗位。每个岗位一行，完整岗位 JD 在最后一列。`]];
...
s.getRange('A6:V6').format={fill:'#8E243A',font:{color:'#FFFFFF',bold:true,size:10},horizontalAlignment:'center',verticalAlignment:'center',rowHeight:32};
...
console.log(JSON.stringify({jobs:jobs.length,jd_fields:jobs.length,output:'小红书2027校招岗位.xlsx'}));
